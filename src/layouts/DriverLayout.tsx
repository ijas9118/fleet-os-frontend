        ...
        <SidebarHeader>
          <div className="flex items-center gap-2 px-1 py-1">
            ...
            <div className="flex flex-col group-data-[collapsible=icon]:hidden">
              ...
              <span className="text-xs text-muted-foreground truncate">Driver Portal</span>
            </div>
          </div>
        </SidebarHeader>
        <SidebarContent>
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem className="hidden md:block">
                <BreadcrumbLink href="/driver">Driver Portal</BreadcrumbLink>
              </BreadcrumbItem>
              {pathSegments.length > 0 && <BreadcrumbSeparator className="hidden md:block" />}
              {pathSegments.map((segment, index) => {
                const isLast = index === pathSegments.length - 1;
                const href = `/driver/${pathSegments.slice(0, index + 1).join("/")}`;
                return (
