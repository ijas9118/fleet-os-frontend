...
export function EditInventoryItemDialog({ item, onItemUpdated }: EditInventoryItemDialogProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-base">
            Update inventory item information. All fields marked with * are required.
          </DialogDescription>
        </DialogHeader>
