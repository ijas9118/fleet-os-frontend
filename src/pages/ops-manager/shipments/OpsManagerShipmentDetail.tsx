...
export default function OpsManagerShipmentDetail() {
  ...
  if (error || !shipment) {
    return (
      <div className="space-y-6">
        <Button variant="ghost" onClick={() => navigate("/ops-manager/shipments")}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <Button
            variant="ghost"
            onClick={() => navigate("/ops-manager/shipments")}
          ...
          <p className="text-muted-foreground text-sm">Shipment Details (Read-only)</p>
        </div>
      </div>
