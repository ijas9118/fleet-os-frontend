...
import { AlertTriangle, ArrowLeft, Car, User, UserPlus, Wrench } from "lucide-react";
...
export default function OpsManagerVehicleDetail() {
  ...
  // Dialog states
  const [assignDialog, setAssignDialog] = useState({ open: false, vehicleId: "", vehicleRegistration: "" });
  ...
  if (error || !vehicle) {
    return (
      <div className="space-y-6">
        <Button variant="ghost" onClick={() => navigate("/ops-manager/vehicles")}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <Button
            variant="ghost"
            onClick={() => navigate("/ops-manager/vehicles")}
        ...
        <div className="flex items-center gap-2">
          {vehicle.assignedDriverId ? (
            <Button variant="outline" onClick={handleUnassignVehicle}>
            ...
            <Button
              onClick={() =>
                setAssignDialog({ open: true, vehicleId: vehicle.id, vehicleRegistration: vehicle.registrationNumber })
              }
            >
