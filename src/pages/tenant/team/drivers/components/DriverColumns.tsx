...
export const getDriverColumns = ({ onBlockDriver, onUnblockDriver, readOnly }: ColumnsOptions): ColumnDef<Driver>[] => {
  ...
  if (!readOnly && onBlockDriver && onUnblockDriver) {
    columns.push({
      id: "actions",
      cell: ({ row }) => {
        const driver = row.original;
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => navigator.clipboard.writeText(driver.email)}>
                Copy email
              </DropdownMenuItem>
              <DropdownMenuSeparator />
